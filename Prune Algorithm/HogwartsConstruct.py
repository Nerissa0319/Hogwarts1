...
def constructNetwork(cancer_genes,nodetype, targetset, g, cancer_name):  # construct cancer network
    ...
    if not os.path.exists(f'{output_path}/prune/{cancer_name}_{nodetype}/{cancer_name}_{nodetype}.gexf'):
        ...
        cancer_network_1 = nx.read_gexf(f'{output_path}/prune/{cancer_name}_{nodetype}/{cancer_name}_{nodetype}.gexf')
    ...
    if not os.path.exists(f'{output_path}/prune/{cancer_name}_{nodetype}/pdist/alpha = 0.2/pdist.txt'):
