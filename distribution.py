...
import numpy as np
# read data
neutral_path = r'D:\Code\Hogwarts\Output\Neutral\statistics\whole_neutral'
signaling_path = r'D:\Code\Hogwarts\Output\Signaling Network\statistics\whole_signaling'
...
g = nx.read_gexf(r'D:\Code\Hogwarts\Output\Neutral\whole_neutral.gexf')
# for u in large:
...
phy = list(set(phy))
node_neu=[]
gsig = nx.read_gexf(r'D:\Code\Hogwarts\Output\Signaling Network\whole_signaling.gexf')
# for u in g.nodes():
...
for i in range(9):
    alpha = (i+1)/10
    with open(f'D:\\Code\\Hogwarts\\Output\\Signaling Network\\target\\whole_signaling\\pdist\\alpha '
