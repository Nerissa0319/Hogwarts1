...
def target_pdist(network_pdist_path, network_target_path, network):
    # find pdist between all target/non-target nodes and cancer/disease nodes
...
def plot_pdist(network_target_path):
...
def st_diff(target_path, filename):
