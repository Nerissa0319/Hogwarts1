...
whole_target_path = os.path.join(output_path, 'target', 'whole_signaling')
# erbc_target_path = os.path.join(output_path,'target','erbc_signaling')
# tnbc_target_path = os.path.join(output_path,'target','tnbc_signaling')
whole_dppr_path = os.path.join(output_path, 'dppr', 'whole_signaling')
# erbc_dppr_path = os.path.join(output_path,'dppr','erbc_signaling')
# tnbc_dppr_path = os.path.join(output_path,'dppr','tnbc_signaling')
whole_pdist_path = os.path.join(output_path, 'pdist', 'whole_signaling')
