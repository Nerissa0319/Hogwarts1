...
'''This file contains all the small functions we may need in multiple files in this program.
Like ranking all the values in a dictionary.'''


# rank values in a dict
def rank(dict):
